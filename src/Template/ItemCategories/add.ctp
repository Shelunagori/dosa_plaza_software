...
<?php $this->set("title", 'Item-Category | DOSA PLAZA'); ?>
<!-- BEGIN PAGE CONTENT-->
						...
						<tr>
							...
							<td class="actions">
								...
								<?php
									...
									<?php echo $this->Html->image('lock.png',['data-target'=>'#deletemodal'.$country->id,'data-toggle'=>'modal','class'=>'tooltips showLoader','data-original-title'=>'Freeze Category','data-container'=>'body']);
									} else { ?>

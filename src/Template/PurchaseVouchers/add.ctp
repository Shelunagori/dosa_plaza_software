    ...
    <div class="col-md-12 main-div">
		<div class= "portlet box blue-hoki">
			<div class="portlet-title">
						<?= $this->Form->create($purchaseVoucher, ['id'=>'configform']) ?>	
				<div class="caption">
					Purchase Vouchers
				</div>
				<div class="row">	
				...
				<div class="form-group">
					<div class="col-md-4">
						<label class="control-label" style="padding:0;">Transaction Date</label>
						 <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" placeholder="dd-mm-yyyy" name="transaction_date" data-date-format="dd-mm-yyyy"/> 
					</div>	
					<div class="col-md-4">
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
	...
	function calculation(obj=null){
		...
		var Totel          = obj.closest('tr').find('td:nth-child(11) input').val(Total_amount); 
		Total_amount       = Total_amount+round_off;
		total_amount_fixed = Total_amount.toFixed(2);
		if(isNaN(total_amount_fixed))
		{
			total_amount_fixed=0;
		}
		if(round_off !='' && !isNaN(round_off)){
			obj.closest('tr').find('td:nth-child(11) input').val(total_amount_fixed);
			grand_total +=total_amount_fixed;
		}
...
<table id="sample" style="display:none;"  width="1500px">
	<tbody class="table_br">
		<tr class="main_tr">
			...
			<td  width="10%" align="center">
				<?php echo $this->Form->input('taxable_value', ['style'=>'text-align:right','label' => false,'class' => 'form-control input-sm  calc taxableValue','type'=>'text']);
				?>	
			</td>

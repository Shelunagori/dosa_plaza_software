...
<?php $this->set("title", 'Bill Delete Report | DOSA PLAZA'); ?>
	...
	<div class="col-md-12 main-div">
		<div class="portlet box blue-hoki">
				...
				<table width="100%" style=" margin-top: 5px; margin-bottom: 5px; ">
					<tr>
						...
						<td width="20%">
							...
							<?php 
								$excelUrl = $this->Url->build(['controller'=>'Bills','action'=>'billWiseSalesDeleteExcel']);
								$excelUrl.='?'.$seturl[1];
							 ?>
			...
			<div class="portlet-body" id="ExcelPage">
				...
				<div>
					<span>Bill Delete Report</span><br/>

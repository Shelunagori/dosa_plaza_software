...
<?php $this->set("title", 'Expanse Voucher | DOSA PLAZA');  //pr($expanseVoucher);exit;?>
<!-- BEGIN PAGE CONTENT-->
    ...
    <div class="col-md-12 main-div">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">Edit Expanse Voucher</div>
                <div class="tools"> </div>
                <div class="row">   
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class=" ">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="date" name="transaction_date" class="form-control" required="required" value="<?php echo date('Y-m-d',strtotime($expanseVoucher->transaction_date)); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class=" ">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <textarea style="resize:none" name="narration" class="form-control" required="required"><?php echo $expanseVoucher->narration; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="col-md-10" style="margin-top:10px;" id="main">
                        <table class="table table-bordered" id="main_table">    
                            ...
                            <tbody id="main_tbody">
                                <?php
                                if(@$expanseVoucher->expanse_voucher_rows){

                                    foreach ($expanseVoucher->expanse_voucher_rows as $key => $value) {
                                        
                                    ?>
                                    <tr class="main_tr">
                                        <td style="vertical-align: top !important;"></td>
                                        <td>
                                            <?php echo $this->Form->input('expanse_head_id',['options'=>$ExpanseHeads,'class'=>'form-control expanse_head_id','empty' => '--Select Head--','label'=>false,'required'=>'required','value'=>$value->expanse_head_id]); ?>
                                        </td>
                                        <td width="20%" >
                                            <?php echo $this->Form->control('amount', ['label' => false, 'placeholder'=>'0.00','class'=>'form-control rightAligntextClass','required'=>'required','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');",'value'=>$value->amount]); ?>
                                        </td>
                                        <td width="20%">

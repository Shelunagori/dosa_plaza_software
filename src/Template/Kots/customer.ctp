...
elseif($searchbox==1){  ?>
	...
	<div class="panel-heading" style="background-color: #2d4161de;">
		<span class="panel-title" style="font-size: 12px; color: #FFF;">
			<i class="fa fa-user font"></i> <?php echo @ucwords($searchBy->name);?>
		</span>
	</div>
	<div class="panel-body" style="border: none; font-size: 8px; padding:10px !important">
		<table width="100%">
			<tr>
				<td width="10%" align="center"><i class="fa fa-phone font"></i> </td>
				<td width="90%"> <?php echo @$searchBy->mobile_no;?> </td>
			</tr>
			<tr>
				<td align="center"><i class="fa fa-envelope font"></i> </td>
				<td> <?php echo @$searchBy->email;?> </td>
			</tr>
			<tr>
				<td align="center"><i class="fa fa-building font"></i> </td>
				<td> <?php echo @$searchBy->address;?> </td>
			</tr>
		</table>
	</div>
	<hr style="margin-top: -9px; margin-bottom: 4px;"></hr>

	...
	<div class="panel panel-default" style=" border: none; ">
		<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion_<?php echo $kot->id; ?>" aria-expanded="false">
			<div class="panel-heading" style="padding:10px;background-color: #E6E7E8;">
				...
				<span data-target="#delete<?php echo $kot->id; ?>" data-toggle='modal' style="color: #000; float: right;"><i class="fa fa-trash pointer"></i></span> 
			</div>
		</a>
				 ...
				 <table width="100%" id="kotTable">
					...
					foreach($kot->kot_rows as $kot_row){ ?>
						<tr style="border-bottom: solid 1px #F1F1F2; ">
							...
							<td style="text-align:center;"><?php echo $this->Html->image('delete.png',['data-target'=>'#deleteitem'.$kot_row->id,'data-toggle'=>'modal','class'=>'tooltips ','data-original-title'=>'Freeze Category','data-container'=>'body']); ?>
